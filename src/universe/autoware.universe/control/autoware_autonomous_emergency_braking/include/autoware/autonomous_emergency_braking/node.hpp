...
public:
  ...
  // service
  rclcpp::Service<std_srvs::srv::Trigger>::SharedPtr aeb_activation_service_;
  // timer
  ...
  // AEB service callback
  void onAEBActivation(
  ...
  // AEB activation control
  bool aeb_activated_{false};
  rclcpp::Time aeb_activation_time_;
  double aeb_activation_duration_{5.0};  // seconds
};
}  // namespace autoware::motion::control::autonomous_emergency_braking
